...
public class Candidate {
    ...
    public void setHotlist(String hotlist) {
        // hotlist holds a named group (e.g. "Top Talent"). Reject blanks and the
        // boolean-coerced junk ("true"/"false") that leaks in when an importer sends
        // a JSON boolean for this String field — otherwise it surfaces as a phantom
        // "false" hotlist in the Candidate page sidebar.
        if (hotlist == null) {
            this.hotlist = null;
            return;
        }
        String t = hotlist.trim();
