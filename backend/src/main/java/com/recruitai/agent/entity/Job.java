...
public class Job {
    ...
    public boolean isPublishedToCareers() {
        return publishedToCareers;
    }

    public void setPublishedToCareers(boolean publishedToCareers) {
        this.publishedToCareers = publishedToCareers;
    }
