...
public interface JobRepository extends MongoRepository<Job, String> {
    ...
    List<Job> findByStatusIn(java.util.Collection<String> statuses);

    List<Job> findByStatusAndPublishedToCareers(String status, boolean publishedToCareers);

    List<Job> findByStatusInAndPublishedToCareers(java.util.Collection<String> statuses, boolean publishedToCareers);
