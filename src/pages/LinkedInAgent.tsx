...
const LinkedInAgent: React.FC = () => {
    ...
    return (
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-white p-3 rounded-xl border border-slate-300 shadow-sm relative overflow-hidden">
        ...
        <div className="flex items-center gap-2 relative z-10">
          ...
          {!isConnected && !isConnecting && (
            <p className="text-[10px] text-gray-600 font-black uppercase tracking-widest">Automated login</p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        <div className="bg-white p-3 rounded-xl shadow-sm border border-slate-300 relative overflow-hidden">
          <div className="relative z-10">
            <label className="block text-[10px] font-black text-gray-600 uppercase tracking-widest mb-2 flex items-center gap-1.5">
            ...
            <div className="flex flex-col md:flex-row gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 focus:bg-white transition-all text-[11px] font-bold placeholder:text-gray-400"
                />
              </div>
              <button
                onClick={handleFetch}
                ...
                {result && (
                    <div className="space-y-8 animate-in slide-in-from-bottom-5 duration-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                            {/* Personal Info Card */}
                            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-300 relative overflow-hidden group">
                                ...
                                <div className="space-y-3 relative z-10">
                                    <div>
                                        <p className="text-[9px] font-black text-gray-600 uppercase tracking-widest mb-1">Full Name</p>
                                        <p className="text-base font-black text-gray-900 leading-none">{result.analysis?.name || 'N/A'}</p>
                                    </div>
                                    <div className="grid grid-cols-2 gap-2">
                                        <div>
                                            <p className="text-[9px] font-black text-gray-600 uppercase tracking-widest mb-1">Email</p>
                                            <p className="text-[10px] font-bold text-gray-700 truncate">{result.analysis?.email || 'N/A'}</p>
                                        </div>
                                        <div>
                                            <p className="text-[9px] font-black text-gray-600 uppercase tracking-widest mb-1">Phone</p>
                                            <p className="text-[10px] font-bold text-gray-700">{result.analysis?.phone || 'N/A'}</p>
                                        </div>
                                    </div>
                                    <div>
                                        <p className="text-[9px] font-black text-gray-600 uppercase tracking-widest mb-1">Role</p>
                            ...
                            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-300 relative overflow-hidden group">
                                ...
                                <div className="space-y-3 relative z-10">
                                    <div className="grid grid-cols-2 gap-2">
                                        <div className="p-2.5 bg-slate-50 rounded-lg border border-slate-300 text-center">
                                            <div className="text-[10px] font-black text-gray-600 uppercase tracking-widest mb-1 leading-none">Experience</div>
                                            <div className="text-lg font-black text-gray-900 leading-none">{result.analysis?.experience || 0}y</div>
                                        </div>
                                        <div className="p-2.5 bg-slate-50 rounded-lg border border-slate-300 text-center">
                                            <div className="text-[10px] font-black text-gray-600 uppercase tracking-widest mb-1 leading-none">Notice</div>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-center py-1 border-b border-slate-300">
                                            <span className="text-[10px] font-black text-gray-600 uppercase tracking-widest">Org</span>
                                            <span className="text-[10px] font-bold text-slate-700 truncate max-w-[100px]">{result.analysis?.currentOrganization || 'N/A'}</span>
                                        </div>
                                        <div className="flex justify-between items-center py-1 border-b border-slate-300">
                                            <span className="text-[10px] font-black text-gray-600 uppercase tracking-widest">Locality</span>
                                            <span className="text-[10px] font-bold text-slate-700">{result.analysis?.locality || 'N/A'}</span>
                                        </div>
                                        <div className="flex justify-between items-center py-1 border-b border-slate-300">
                                            <span className="text-[10px] font-black text-gray-600 uppercase tracking-widest">Japanese</span>
                                        ...
                                        <div className="flex justify-between items-center py-1">
                                            <span className="text-[10px] font-black text-gray-600 uppercase tracking-widest">Reason</span>
                            ...
                            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-300 relative overflow-hidden group">
                                ...
                                <div className="space-y-4 relative z-10">
                                    {[
                                        ...
                                        <div key={i}>
                                            <p className="text-[9px] font-black text-gray-600 uppercase tracking-widest mb-1.5 leading-none">{cat.label}</p>
